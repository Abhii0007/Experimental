...
################################################################################
## Form generated from reading UI file 'Form1DbzYep.ui'
##
...
class Ui_master(object):
    def setupUi(self, master):
        ...
        master.setStyleSheet(u"background-color: rgb(67, 133, 134);")
...
"selection-background-color: rgb(214, 214, 214);")
        ...
        self.pushButton_clear.setGeometry(QRect(564, 560, 151, 33))
        ...
        self.pushButton_open_site.setGeometry(QRect(461, 560, 101, 33))
        ...
        self.lineEdit_command.setGeometry(QRect(43, 39, 571, 31))
        font2 = QFont()
        font2.setPointSize(12)
        font2.setBold(True)
        self.lineEdit_command.setFont(font2)
        self.lineEdit_command.setStyleSheet(u"background-color: rgb(0, 0, 0);\n"
...
"selection-background-color: rgb(58, 115, 116);")
    ...
    def retranslateUi(self, master):
        ...
        self.comboBox.setItemText(0, QCoreApplication.translate("master", u"Run Server", None))
        self.comboBox.setItemText(1, QCoreApplication.translate("master", u"ShowDatabase", None))
        self.comboBox.setItemText(2, QCoreApplication.translate("master", u"Admin", None))
        self.comboBox.setItemText(3, QCoreApplication.translate("master", u"OpenShell", None))
        self.comboBox.setItemText(4, QCoreApplication.translate("master", u"Check", None))
        self.comboBox.setItemText(5, QCoreApplication.translate("master", u"Create New App", None))
        self.comboBox.setItemText(6, QCoreApplication.translate("master", u"Make Migration", None))
        self.comboBox.setItemText(7, QCoreApplication.translate("master", u"Apply Migration", None))
        self.comboBox.setItemText(8, QCoreApplication.translate("master", u"Show Migration", None))
        self.comboBox.setItemText(9, QCoreApplication.translate("master", u"Flush Database", None))
